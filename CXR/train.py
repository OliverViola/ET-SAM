...
from utils import select_few_shot_samples, predict_mask, save_training_data
...
WD = 5e-5
DEVICE="cuda"
BS = 1  # Reduced batch size for smaller training set
...
def few_shot_train():
    ...
    scheduler = CosineAnnealingWarmRestarts(
        optimizer,
        T_0=50,           # Initial period length
        T_mult=1,         # Period length multiplier
        eta_min=1e-6
    )
